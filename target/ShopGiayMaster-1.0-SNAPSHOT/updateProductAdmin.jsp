                                ...
                                <form action="update" method="post">
                                    <div class="row">
                                        <div class="col-md-3 px-1">
                                            <div class="form-group">
                                                <label>Name</label>
                                                <input type="text" class="form-control" placeholder="id" name="id" value="${product.id}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 px-1">
                                            <div class="form-group">
                                                <label>Image</label>
                                                <input type="file" class="form-control" placeholder="image" name="image" value="${product.image}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 pr-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="category" name="cid" value="${product.category.id}">
<%--                                                <input type="text" class="form-control" placeholder="price" name="cid" value="${product.category.id}">--%>
                                            </div>
                                        </div>
                                    </div>
                                    <input type="submit" class="btn btn-info btn-fill pull-right" value="Update">
